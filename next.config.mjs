const nextConfig = {
  env: {
    BACKEND_API_URL: 'https://stonehill-be.sustainext.ai',
    ...
    AUTH0_BASE_URL: 'https://stonehill-platform.sustainext.ai',
    ...
    AUTH0_REDIRECT_URL: 'https://stonehill-platform.sustainext.ai/callback',
    ...
    KEYCLOAK_BASE_URL: 'https://stonehill-platform.sustainext.ai',
    KEYCLOAK_LOGOUT_URl:
 ...
 async headers() {
  ...
  images: {
    domains: [
      'stonehill-platform.sustainext.ai',
